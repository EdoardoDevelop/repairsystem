    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <div class="form-control"><select class="form-control select2" name="id_cliente" id="id_cliente" required></select></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nome" class="form-control" placeholder="Inserisci il nome" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="telefono">Telefono</label>
                                <input type="text" id="telefono" class="form-control" placeholder="Inserisci il telefono" required>
                            </div>
                            <div class="form-group">
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="date" name="data_consegna" id="data_consegna" class="form-control" value="<?= $dati['data_consegna'] ?? '' ?>" required>
        </div>
        <div class="form-group">
